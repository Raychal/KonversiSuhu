package com.raychal.testkonvesisuhu.uitls;
...
public class Temperatures {
    ...
    public String FahrenheitToReamur(double fahrenheit) {
        // rumus : R = (F - 32) / 0,44
        double R = (fahrenheit - 32) * (4.0 / 9.0);
        return check_after_decimal_point(R);
    }
    ...
    public String KelvinToReamur(double kelvin) {
        // rumus : R = (4.0 / 5.0) * (K - 273)
        double R = (4.0 / 5.0) * (kelvin - 273);
        return check_after_decimal_point(R);
    }

    // K to F
    public String KelvinToFahrenheit(double kelvin) {
        // rumus : F = (9.0 / 5.0) * (K - 273) + 32
        double F = (9.0 / 5.0) * (kelvin - 273) + 32;
        return check_after_decimal_point(F);
    }
    ...
    public String getFormula(String symbol1, String symbol2, double value_to_conversion, String result) {
        ...
        // F to R
            ...
            results = symbol2 + "  =  (" + symbol2 + "  -  32)  (4.0 / 9.0)\n" + symbol2
                    + "  =  (" + check_after_decimal_point(value_to_conversion) + "  -  32)  (4.0 / 9.0)\n" + symbol2 + "  =  " + result;
        }
        // F to K
        else if (symbol1.equals("\u00B0F") && symbol2.equals("K")) {
            results = symbol2 + "  =  (" + symbol2 + "  +  459,67)  /  1,8\n" + symbol2
                    + "  =  (" + check_after_decimal_point(value_to_conversion) + "  -  459,67)  /  1,8\n" + symbol2 + "  =  " + result;
        }
        // K to C
        ...
        // K to R
            ...
            results = symbol2 + "  =  (4.0 / 5.0) * (" + symbol1 + "  -  273)\n" + symbol2
                    + "  =  (4.0 / 5.0) * (" + check_after_decimal_point(value_to_conversion) + "  -  273)\n" + symbol2 + "  =  " + result;
        }
        // K to F
        else if (symbol1.equals("K") && symbol2.equals("\u00B0F")) {
            results = symbol2 + "  = (9.0 / 5.0) * (" + symbol1 + "  -  273)  + 32\n" + symbol2
                    + "  = (9.0 / 5.0) * (" + check_after_decimal_point(value_to_conversion) + "  -  273) + 32\n" + symbol2 + "  =  " + result;
        }
        return results;
    }
}
